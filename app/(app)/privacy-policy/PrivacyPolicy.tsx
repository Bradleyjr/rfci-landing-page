        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <SectionReveal direction="up">
            <div className="prose prose-lg max-w-none text-rfci-black/70 leading-relaxed space-y-10">
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Introduction</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Information We Collect</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Automatic Data Collection</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Use of Information</h3>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Data Sharing</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Analytics</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Cookies</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Third-Party Links</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Social Media</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Updates to This Policy</h3>
                <p>
