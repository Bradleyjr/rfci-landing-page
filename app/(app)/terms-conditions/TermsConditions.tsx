        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <SectionReveal direction="up">
            <div className="prose prose-lg max-w-none text-rfci-black/70 leading-relaxed space-y-10">
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Agreement to Terms</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Use of the Sites</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Intellectual Property</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Disclaimer of Warranties</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Limitation of Liability</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Third-Party Links and Services</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">User Submissions</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Indemnification</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Governing Law</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Changes to These Terms</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-display font-light text-rfci-black mb-4">Contact Us</h3>
                <p>
