...
const FLOORING_FALLBACK: Record<string, any> = {
  ...
  'sheet-vinyl': {
    ...
    advantages: [
      ...
      'Heterogeneous: Commercial grades offer not only superior durability but also attractive design alternatives',
  ...
  'vct': {
    title: 'Vinyl Composition Tile', subtitle: '', slug: 'vct',
    accentColor: '#0164DB',
    diagrams: [
  ...
  'linoleum': {
    title: 'Linoleum', subtitle: '', slug: 'linoleum',
    accentColor: '#2E7D32',
    diagrams: [
  ...
  'rubber': {
    title: 'Rubber Flooring', subtitle: '', slug: 'rubber',
    accentColor: '#37474F',
    diagrams: [
  ...
  'cork': {
    title: 'Cork Flooring', subtitle: '', slug: 'cork',
    accentColor: '#8D6E63',
    diagrams: [
