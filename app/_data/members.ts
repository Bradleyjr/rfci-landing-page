...
export const MEMBERS: Member[] = [
  ...
  { name: 'Bentley',           logoUrl: '/media/member-logos/bentley.png',            website: 'https://bentleymills.com',      tier: 'board', row: '1', order: 4 },
  ...
  { name: 'Congoleum',         logoUrl: '/media/member-logos/congoleum.png',          website: 'https://congoleum.com',         tier: 'board', row: '1', order: 7 },
  ...
  // Board members — Row 2
  { name: 'Lonseal',           logoUrl: '/media/member-logos/lonseal.png',            website: 'https://lonseal.com',           tier: 'board', row: '2', order: 1 },
