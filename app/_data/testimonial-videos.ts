...
export const TESTIMONIAL_VIDEOS: TestimonialVideo[] = [
  ...
  {
    title: 'Ralph Grogan of Taylor Adhesives',
    company: 'Taylor Adhesives',
    segment: 'Supply Chain',
    quote: 'Fantastic information you can\'t get anywhere else.',
    thumbnailUrl: '/media/testimonials/ralph-grogan-taylor.png',
    videoUrl: '#',
    order: 8,
  },
  {
    title: 'Susannah Enkema of ERM Shelton',
    company: 'ERM Shelton',
    segment: 'Supply Chain',
    quote: 'Beautifully Responsible has really been a great campaign.',
    thumbnailUrl: '/media/testimonials/susannah-enkema-erm-shelton.png',
    videoUrl: '#',
    order: 9,
  },
]
