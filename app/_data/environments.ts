...
export const ENVIRONMENTS: Environment[] = [
  ...
  { name: 'Townhomes & Duplexes', flooringType: 'Flexible LVT',            image: { url: 'https://images.unsplash.com/photo-1600566753086-00f18f6b6637?w=800&auto=format&fit=crop' }, order: 3 },
