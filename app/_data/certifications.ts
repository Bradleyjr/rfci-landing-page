...
{ question: 'Why do we need AFFIRM Certified?', answer: 'The AFFIRM Certified label provides a way for designers, architects, facility managers, procurement agents and end-users to easily recognize that a resilient flooring product has completed a third party, independent certification process demonstrating commitment to sustainability, human health, and social responsibility. Because there are both required (Level 1) and optional criteria (Level 2), manufacturers can use the standard for continual improvement.' },
  ...
  },
  {
    ...
    benefits: [],
    downloads: [
      { title: 'Heterogeneous Sheet', year: '2024', category: '2024 Industry Wide EPDs', url: 'https://rfci.com/wp-content/uploads/2024/05/SCS-EPD-10144_RFCI_Heterogeneous-Sheet_050924_compressed.pdf' },
      { title: 'Homogeneous Sheet', year: '2024', category: '2024 Industry Wide EPDs', url: 'https://rfci.com/wp-content/uploads/2024/05/SCS-EPD-10145_RFCI_Homogeneous-Sheet_050924_compressed.pdf' },
      ...
      { title: 'Heterogeneous Vinyl Flooring', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/101.1_RFCI_EPD_Heterogeneous-Vinyl-Flooring.pdf' },
      { title: 'Homogeneous Vinyl Flooring', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/102.1_RFCI_EPD_Homogeneous-Vinyl-Flooring.pdf' },
      { title: 'Rigid Core Flooring', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/103.1_RFCI_EPD_Rigid-Core-Flooring.pdf' },
      { title: 'Rubber Flooring', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/104.1_RFCI_EPD_Rubber-Flooring.pdf' },
      { title: 'Vinyl Tile', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/106.1_RFCI_EPD_Vinyl-Tile.pdf' },
      { title: 'Vinyl Composition Tile', year: '2019', category: '2019 Industry Wide EPDs (Archived)', url: 'https://rfci.com/wp-content/uploads/2019/01/105.1_RFCI_EPD_Vinyl-Composition-Tile.pdf' },
    ],
