...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    benefits: [
      ...
      { title: 'LEED & Green Building Credits', description: 'Recognized by LEED v4.1, WELL, BREEAM, CHPS, Green Globes, and more.' },
  ...
  },
  {
    ...
    benefits: [
      ...
      { title: 'Ortho-Phthalates Free', description: 'Products cannot exceed 1,000 PPM for any individual or combined ortho-phthalates \u2014 tested per CPSC-CH-C1001-09.4.' },
    ...
    process: [
      ...
      { step: 'Performance & Chemistry Testing', description: 'Products tested per ASTM F3261 (performance), EPA SW 846 (heavy metals), and CPSC-CH-C1001-09.4 (ortho-phthalates).' },
  ...
  },
  {
    ...
    iconName: 'globe',
    description: 'AFFIRM\u2122 Certified is a sustainability certification for resilient flooring based on NSF/ANSI 332, an ANSI-accredited consensus standard. It evaluates products across environmental, health & wellness, and social impact categories \u2014 with two certification levels and independent third-party verification.',
    stats: [
    ...
    benefits: [
      ...
      { title: 'Public Health Council Review', description: 'All standards reviewed by the NSF Council of Public Health Consultants \u2014 composed of professionals from federal and state agencies, academic institutions, and recognized public health leaders.' },
