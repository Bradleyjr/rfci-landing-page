...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    logoUrl: '/media/cert-logos/floorscore.png',
  ...
  },
  {
    ...
    iconName: 'seal',
    logoUrl: '/media/cert-logos/assure.jpg',
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How does AFFIRM\u2122 Certified differ from other certifications?', answer: 'Multi-attribute standards like AFFIRM are responsive to market requests for a more comprehensive approach for determining environmentally preferable products. Single attribute programs serve a purpose, but more comprehensive standards like AFFIRM include environmental, health and wellness, and social responsibility requirements \u2014 highly indicative of environmentally preferable products (EPP).' },
      ...
      { question: 'Who worked on the AFFIRM\u2122 Certified standard?', answer: 'The AFFIRM\u2122 Certified standard and its revisions are developed through the involvement of stakeholders directly affected by the scope of the standard. A joint committee including public health, industry, and user members is responsible for proposing standards, voting on standards, ensuring public health and safety, and addressing environmental concerns.' },
