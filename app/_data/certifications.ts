...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    benefits: [
      ...
      { title: 'Healthier Air for Occupants', description: 'IAQ is important because most people spend around 90% of their time indoors. Poor quality air can increase risk for a variety of health problems, including headaches, dizziness, and more serious long-term conditions. FloorScore\u00ae certification means healthier, cleaner air.' },
    ...
    faqs: [
      { question: 'Where can I find a list of flooring products that have earned the FloorScore\u00ae seal?', answer: 'A current list is maintained at scscertified.com.' },
      ...
      { question: 'Why does IAQ matter?', answer: 'If you\u2019re like most people, you spend over 90% of your life indoors. Poor IAQ can be a factor in a variety of health problems, such as headaches and dizziness and more serious long-term effects.' },
      ...
      { question: 'Where can I learn more?', answer: 'The U.S. Environmental Protection Agency (EPA) maintains a website that provides information on indoor air quality at epa.gov/iaq. You can also find out about all the indoor air quality certifications offered by SCS at scscertified.com.' },
  ...
  },
  {
    ...
    benefits: [
      { title: 'Indoor Air Quality Compliant', description: 'Must comply with CDPH Standard Method v1.2 testing and meet the concentration limits of \u00bd the corresponding CREL in Appendix C when a product is modeled as flooring for both the classroom and private office scenarios.' },
      { title: 'Performance Tested', description: 'Must meet ASTM F3261 Characteristics testing for composition, size tolerance, product thickness, and wear layer thickness.' },
      { title: 'Heavy Metals', description: 'Must be tested for lead, hexavalent chromium, cadmium, and mercury per test method EPA SW 846 Method 3052 and not exceed the limits of 100 PPM by combined weight. Additionally, manufacturers attest that neither lead, mercury, cadmium, nor hexavalent chromium were intentionally added to the product in the manufacturing process.' },
    ...
    getStartedDescription: 'Product certification is met upon completion of quality assurance testing and a satisfactory on-site audit of the manufacturing facility. Manufacturer must have a quality control procedure covering material suppliers, product traceability, chain of custody, internal QC testing, and segregation of non-conforming products/materials.',
